...
useEffect(()=>{
 ...
 axios.get('user/LoggingCheck').then((succs)=>{
...
axios.delete('/user/logout').then((succs)=>{
    ...
    return (
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <Link class='nav-item' to="/create/user" > create user </Link>
            </ul>
            <ul class="navbar-nav">
...
{  (LoggedInUser && LoggedInUser.username) ? 
           ...
           <ul class="navbar-nav">
           <Link class='nav-item' to="/user/login" > login </Link>
           </ul>
          ...
          {  (LoggedInUser && LoggedInUser.username) ? <h6> welcome {LoggedInUser.username} </h6>  : ''  }
